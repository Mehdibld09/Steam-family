    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-4xl px-4 py-8">
        ...
        <Card className="bg-white">
          <CardHeader>
            <CardTitle className="text-3xl text-neutral-900">Terms of Service</CardTitle>
          </CardHeader>
          <CardContent className="prose max-w-none space-y-6 text-neutral-900">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-neutral-900">Terms of Service</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-3 text-neutral-900">Use of Services</h2>
